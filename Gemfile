...
# gem 'bcrypt', '~> 3.1.7'
# ActiveModel::Serializers allows you to generate your JSON in an object-oriented and convention-driven manner. Read more: https://github.com/rails-api/active_model_serializers
